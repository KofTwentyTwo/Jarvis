...
| 01-02-T1 | 01-02-keychain-config-logging | 2 | SEC-01 | T-02-01 | API key round-trips through Keychain via SystemKeychainStore at com.kingsrook.jarvis.anthropic | unit | `cd packages/Keychain && swift test` (test_setGetDeleteRoundTrip, test_anthropicConstantMatchesD10) | packages/Keychain/Tests/KeychainTests/KeychainTests.swift | ⬜ pending |
